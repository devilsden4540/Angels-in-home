...
$uid = $_SESSION['uid'];
$qry = "SELECT * FROM `customers` c, `login`l WHERE c.`cid`='$uid' AND c.`cid`=l.`uid` AND l.`utype`='Customer'";
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-4 mt-1">
                <div class="col-lg-6" style="margin: auto;">
                    <form action="" method="post">
                        <div class="row gy-4 mb-3 ">
                            ...
                            <div class="col-lg-6 form-group">
                                <input type="email" class="form-control" name="email" id="email" placeholder="Your Email" value = "<?php echo $row['email'] ?>" readonly required>
                            </div>
                        </div>
                        <div class="row gy-4 mb-3 ">
                            <div class="col-lg-6 form-group">
                ...
                <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" required>
                        ...
                        <div class="row gy-4 mb-3 ">
                            <div class="col-lg-6 form-group">
                                <input type="password" name="password" value = "<?php echo $row['password'] ?>" class="form-control" id="name" placeholder="Password" required>
                            </div>
                            <div class="col-lg-6 form-group">
...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cPassword) {
            ...
            $qry = "UPDATE `customers` SET `name`='$name', `phone`='$phone', `address`='$address', `district`='$district' WHERE `cid`='$uid'";
            $qryLog = "UPDATE `login` SET `password`='$password' WHERE `uid`='$uid' AND `utype`='Customer'";
